...
public class InfoPrinter {
    ...
    public void line(String text) {
        line(Text.literal(text));
    }

    public void value(String parameter, String value) {
        if (value != null && !value.isEmpty())
            line(Text.literal(parameter).styled(style -> style.withBold(true)).append(notStyled(": " + value)));
    }
    ...
    public void link(String parameter, String value) {
        if (value != null && !value.isEmpty())
            line(Text.literal(parameter).styled(style -> style.withBold(true)).append(notStyled(": ").append(Text.literal(value).setStyle(linkStyle(value)))));
    }
    ...
    public void listTitle(String text) {
        line(Text.literal(text).styled(style -> style.withBold(true)).append(notStyled(":")));
    }

    public void listEntry(String text) {
        listEntry(Text.literal(text));
    }

    public void listEntry(MutableText text) {
        line(Text.literal("- ").styled(style -> style.withColor(Formatting.GRAY)).append(notStyled(text)));
    }
    ...
    public <T> void list(String title, Collection<T> collection, Function<T, @Nullable String> entryFormat) {
        listTexts(title, collection, t -> {
            ...
            return entryString != null ? Text.literal(entryString) : null;
        });
    }
    ...
    public static MutableText notStyled(String string) {
        return notStyled(Text.literal(string));
    }
